        ...
        <footer className="border-t border-gray-200 bg-gray-50">
            <div className="container mx-auto px-6 py-8 grid gap-8 grid-cols-1 lg:grid-cols-2">
                <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-3 text-xs font-semibold uppercase tracking-[0.2em] text-gray-600">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">Navigate</p>
